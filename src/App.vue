...
//   sortPosts: Post[] = this.sort()
//   searchPosts: Post[] = this.search()
  sortPosts() {
    return [...this.posts].sort((p1: Post, p2: Post) => p1[this.selectSort]?.localeCompare(p2[this.selectSort]))
  }
  get searchPosts() {
    return this.sortPosts().filter((p: Post) => p.title.toUpperCase().includes(this.searchPostTitle.toUpperCase()))
  }
}

// export default interface App {
//   $refs: {
//      MyButton: any; // на самом деле не any, а интерфейс компонента, поддерживающий нужные методы
//   }
// }

// export default {
//     components: {
//         App, MyButton, PostList, MyInput, MyDialog, MySelect
//     },
//     data() {
//         return { App }
//     }
